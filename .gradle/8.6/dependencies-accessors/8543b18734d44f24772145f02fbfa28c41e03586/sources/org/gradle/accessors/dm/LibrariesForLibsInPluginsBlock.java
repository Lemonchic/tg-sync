...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final HammerheadLibraryAccessors laccForHammerheadLibraryAccessors = new HammerheadLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>hammerhead</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public HammerheadLibraryAccessors getHammerhead() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForHammerheadLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class HammerheadLibraryAccessors extends SubDependencyFactory {
        private final HammerheadKarooLibraryAccessors laccForHammerheadKarooLibraryAccessors = new HammerheadKarooLibraryAccessors(owner);

        public HammerheadLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>hammerhead.karoo</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public HammerheadKarooLibraryAccessors getKaroo() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForHammerheadKarooLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class HammerheadKarooLibraryAccessors extends SubDependencyFactory {

        public HammerheadKarooLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>ext</b> with <b>io.hammerhead:karoo-ext</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getExt() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("hammerhead.karoo.ext");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidxComposeMaterial</b> with value <b>1.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxComposeUi</b> with value <b>1.7.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
